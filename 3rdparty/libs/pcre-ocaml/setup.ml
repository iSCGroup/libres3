...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7b83d66fb924d736654b3d9a5520a0c6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            ["(C) 1999-2012 Markus Mottl <markus.mottl@gmail.com>"];
          maintainers = ["Markus Mottl <markus.mottl@gmail.com>"];
          authors = ["Markus Mottl <markus.mottl@gmail.com>"];
          homepage = Some "https://bitbucket.org/mmottl/pcre-ocaml";
          synopsis =
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples/cloc";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "pcre"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "cloc.ml"});
               Executable
                 ({
                     cs_name = "count_hash";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "count_hash.ml"});
               Executable
                 ({
                     cs_name = "pcregrep";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "pcregrep.ml"});
               Executable
                 ({
                     cs_name = "subst";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "subst.ml"});
               Doc
                 ({
                     cs_name = "API";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for PCRE-OCaml";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Hg;
                      src_repo_location =
                        "ssh://hg@bitbucket.org/mmottl/pcre-ocaml";
                      src_repo_browser =
                        Some "https://bitbucket.org/mmottl/pcre-ocaml";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\224R\175\234\156_\187J\255\"\228\029\188\163V\135";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
