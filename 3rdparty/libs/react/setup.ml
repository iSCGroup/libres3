...
(* OASIS_START *)
(* DO NOT EDIT (digest: 80aa4c9fa91e67754a0644227176230f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = ["(c) 2009-2012 Daniel C. B√ºnzli"];
          maintainers = [];
          authors = ["Daniel B√ºnzli <daniel.buenzli at erratique.ch>"];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "R÷H\127±\015t›PX68›\002\025¡";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
