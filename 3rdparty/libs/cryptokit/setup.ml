...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5a5ef84774d6f4689c86ed9dadfa1ccd) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("bench",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$speedtest", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     doc = [("api-cryptokit", OCamlbuildDocPlugin.doc_build "src/")];
     ...
     clean_doc = [("api-cryptokit", OCamlbuildDocPlugin.doc_clean "src/")];
     distclean = [];
     distclean_test =
       [
          ("main",
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Enable ZLib";
                      flag_default =
                        [
                  ...
                  },
                   {
                      ...
                      bs_ccopt =
                        [
                           ...
                           (OASISExpr.EFlag "zlib", ["-O"; "-DHAVE_ZLIB"])
                        ];
                      bs_cclib =
                        [
                           (OASISExpr.EBool true, []);
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build and run benchmark";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "speedtest.ml"});
               Test
                 ({
                     cs_name = "bench";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/cryptokit";
                      doc_title = "API reference for Cryptokit";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "w\213\245\012.\000\241\249\007\181\"\202\251Q\001^";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
