...
(* OASIS_START *)
(* DO NOT EDIT (digest: a171157c86f907dced7cf8df31b84f2f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["OUnitThreads"];
                      lib_pack = false;
                      lib_internal_modules = ["OUnitRunnerThreads"];
                      lib_findlib_parent = Some "oUnit";
                      lib_findlib_name = Some "threads";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                     cs_name = "testFakeHTML";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "testFakeHTML.ml"; });
               Executable
                 ({
                     cs_name = "testFakeRunner";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "testFakeRunner.ml"; 
                   });
               Executable
                 ({
                     cs_name = "testFakeShared";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "testFakeShared.ml"; 
                   });
               Executable
                 ({
                     cs_name = "test";
                     ...
                     },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "testFakeHTML";
                           InternalExecutable "testFakeRunner";
                           ExternalTool "xmllint"
                        ];
                      });
               Doc
                 ({
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "x\195@\135YU\224\203\207{\141\001\249\186[/";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
