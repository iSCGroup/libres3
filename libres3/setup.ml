...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6f27d6e9f8b72e360fc189cc2ca9ecbd) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$misc_test", []))];
          ...
          ("directio",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$directio_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("lwtio",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$lwtio_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          findlib_version = Some (OASISVersion.VGreaterEqual "1.2.0");
          alpha_features = [];
          beta_features = [];
          name = "libres3";
          version = "0.1";
          ...
          homepage = Some "http://www.skylable.com/products/libres3";
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("chmod", ["+x"; "src/files/sbin/libres3"])))
                 ]
            };
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("rm",
                           ["-f"; "bisect*.out"; "reply.log"; "sigs.log"])))
                 ]
            };
          distclean_custom =
            {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build ocsigen-based standalone server";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build fcgi-based server (for development only)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                     cs_name = "internaldocs";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description = Some "build internal docs";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/sxclient";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("netclient", None);
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "ocsigen", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "src/sxclient/lwt";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "sxclient";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "sxclient.thread"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "sxuls.ml"});
               Executable
                 ({
                     cs_name = "sxucp";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "sxucp.ml"});
               Doc
                 ({
                     cs_name = "api-client";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title =
                        "API reference for SX client monad interface";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                        ...
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "docs",
                                OASISExpr.EFlag "internaldocs"),
                             true)
                        ];
                      doc_install = [(OASISExpr.EBool true, false)];
                      doc_install_dir = "$docdir";
                      doc_title = "API reference for server";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "server";
                           InternalLibrary "sxclient.thread";
                           FindlibPackage ("netcgi2", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "fcgi/libres3_fcgi.ml"
                   });
               Library
                 ({
                     cs_name = "libres3_site";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "libres3_site"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files =
                        [
                           ("../files/conf/libres3.sample.s3cfg",
                             Some "$sysconfdir/libres3/");
                           ("../files/conf/libres3-insecure.sample.s3cfg",
                             Some "$sysconfdir/libres3/");
                           ("../files/conf/logrotate.d/libres3",
                             Some "$docdir/logrotate.d/");
                           ("../files/sbin/libres3_env.sh", Some "$sbindir/");
                           ("../files/sbin/libres3", Some "$sbindir/");
                           ("../../README", Some "$docdir/");
                           ("../../COPYING", Some "$docdir/")
                        ];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "libres3_ocsigen.ml"});
               Executable
                 ({
                     cs_name = "libres3_setup";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "libres3_setup.ml"});
               Executable
                 ({
                     cs_name = "server_test";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_directio.ml"});
               Executable
                 ({
                     cs_name = "lwtio_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_lwtio.ml"});
               Executable
                 ({
                     cs_name = "misc_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_misc.ml"});
               Executable
                 ({
                     cs_name = "net_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "netTest.ml"});
               Test
                 ({
                     cs_name = "misc";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\236\216\236\1434\236\005\141\127\147K[\015\231Uo";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
